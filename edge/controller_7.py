...
INCIDENT_TOPIC_PREFIX = "edge/incident"
...
FAKE_LOC_HZ = 2.0   # was 1.0

# Human movement limits (smaller steps)
MAX_SPEED_MPS = 0.85      # was 1.35
MAX_ACCEL_MPS2 = 0.18     # was 0.35
...
# =========================================================
INCIDENT_RADIUS_M = 22.0        # was 55m
INCIDENT_LEAD_START_M = 70.0    # was 180m
INCIDENT_LEAD_MIN_M = 25.0      # was 35m
INCIDENT_LEAD_SHRINK_MPS = 0.12 # was 0.30
INCIDENT_MIN_MOVE_M = 1.2       # slightly tighter stability (was 2.0)

# Staging offsets relative to incident (tighter)
STAGE_OFFSET_M = 8.0            # was 18m
C_PUSH_IN_M = 6.0               # was 10m
...
class GoalWalker:
    ...
    def step_to_goal(self, dt: float, goal_lat: float, goal_lon: float):
        ...
        # slow earlier -> smaller steps near perimeter
...
def incident_targets(a_lat: float, a_lon: float) -> Dict[str, Tuple[float, float]]:
    ...
    # C: closer, sometimes slightly inside
    t = time.time()
